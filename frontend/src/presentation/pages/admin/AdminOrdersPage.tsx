...
export function AdminOrdersPage() {
  return (
    <div className="p-10 animate-fade-in">
      ...
      <p className="text-text-muted text-lg mb-8">Administración de órdenes de trabajo del taller</p>
      <div className="glass-card p-16 text-center">
        ...
        <p className="text-text-muted text-sm">
          Aquí se listarán y gestionarán todas las órdenes con sus estados.
        </p>
      </div>
    </div>
  );
